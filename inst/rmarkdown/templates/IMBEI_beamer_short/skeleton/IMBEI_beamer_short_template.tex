\documentclass[compress,$if(fontsize)$$fontsize$,$endif$%
...
\mode<presentation>{
	...
	\setbeamercolor{mini frame}						{fg=UniDarkBlue}
	...
	\setbeamertemplate{headline}{														%%  contents of headline
		...
		\hskip9pt
		\begin{minipage}{3in}
				\vskip-10pt \color{UniDarkBlue} \insertauthor : \,\, \insertshorttitle 
		\end{minipage}
		\hfill
		\IfFileExists{Universitaetsmedizin.jpg}{\includegraphics[height=0.5cm]{Universitaetsmedizin.jpg}}{\vskip0.5cm}
		\vskip2pt
	}
